...
import { listAccounts, suggestJournalEntryNumber } from "@/lib/accounting/service";
...
export default async function NewJournalPage() {
  ...
  const [accounts, suggestedNumber] = await Promise.all([
    listAccounts(),
  ...
  return <main className="mx-auto w-full max-w-7xl px-5 py-8"><div className="space-y-6">
    ...
    <section className="card p-5 sm:p-7"><JournalComposer accounts={accounts} suggestedNumber={suggestedNumber} initialDate={today} /></section>
  </div></main>;
}
